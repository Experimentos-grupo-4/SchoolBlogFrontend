...
export class AuthenticationComponent {
  ...
  constructor(private router:Router, private customerService:StudentsService,private fb:FormBuilder){
  ...
  async registro(){
    ...
    if(this.imprimirFecha()){
      if(await this.customerService.validateUser(customer.email)){
        ...
        this.msgError=true;
        this.msg_error="Ha ingresado un correo que ya esta en el sistema."
        this.register.reset();
      }
    }
    else{
